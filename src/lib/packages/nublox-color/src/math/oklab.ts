...
export const rgbToOklch = (rgb: Rgb): Oklch => oklabToOklch(linearRgbToOklab(rgbToLinear(rgb)));
export const oklchToRgb = (oklch: Oklch): Rgb => linearToRgb(oklabToLinearRgb(oklchToOklab(oklch)));
