import type { RampProfile, Stop } from '../types.js';
const uiLightness: Record<Stop, number> = {50:.975,100:.945,200:.890,300:.815,400:.705,500:.600,600:.515,700:.420,800:.325,900:.245,950:.180};
export const uiProfile: RampProfile = {
...
export const paintProfile: RampProfile = {
...
export const accessibilityProfile: RampProfile = {
...
export const displayProfile: RampProfile = {
...
export const profiles = { ui: uiProfile, paint: paintProfile, accessibility: accessibilityProfile, display: displayProfile } as const;
export function resolveProfile(profile: any = 'ui'): RampProfile {
  if (typeof profile === 'string') return profiles[profile as keyof typeof profiles] ?? uiProfile;
  return profile;
}
