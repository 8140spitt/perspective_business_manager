...
export const capabilityMap: CapabilityArea[] = [
	...
	},
	{
		...
		currentRoutes: [
			...
			'/app/instructions',
			'/app/instructions/[instructionId]',
			'/app/surveys'
		],
	...
	},
	{
		...
		currentRoutes: [
			...
			'/app/reporting/compliance-reports',
			'/app/reporting/exports',
			'/app/reporting/financial-reports',
			'/app/reporting/kpis',
			'/app/reporting/operations-reports',
			'/app/reporting/project-reports',
			'/app/reporting/sales-reports',
			'/app/reporting/utilisation-reports',
			'/app/reports',
			'/app/documents',
